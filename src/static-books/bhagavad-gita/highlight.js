/**
 * Bhagavad Gita - Text Highlighting Feature
...
(function() {
    ...
    // Constants
    const STORAGE_KEY = 'gita_highlights';
    ...
    function findAnchorElement(node) {
        ...
        // Look for section, verse, key-points, or other structural elements
    ...
    function createHighlightData(selection) {
        ...
        // Get context text (10 chars before and after)
    ...
    function handleSelectionChange() {
        ...
        setTimeout(function() {
            ...
            console.log('Selection detected:', selectedText ? selectedText.substring(0, 50) + '...' : '(empty)');

            if (isValidSelection(selection)) {
                console.log('Selection is valid, showing button');
