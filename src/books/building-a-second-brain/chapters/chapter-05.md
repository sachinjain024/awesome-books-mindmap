---
number: 5
title: Organize — Save for Actionability
meta: The PARA Method
part: "The Method — The Four Steps of CODE"
layout: chapter
book: building-a-second-brain
permalink: building-a-second-brain/chapters/chapter-05.html
---

> "Your notes should be organized not by where they came from, but by where they are going."
> — Tiago Forte
...
### The Hierarchy of Actionability {.code-box}

PARA is ordered by actionability:

1. **Projects** — most actionable (active right now)
2. **Areas** — moderately actionable (ongoing, but not urgent)
3. **Resources** — potentially actionable (for future reference)
4. **Archives** — least actionable (for historical reference)
...
## Moving Information Through PARA
...
### Practical Example {.technique-box}

You read an article about negotiation techniques and save a few key passages. Where do they go?

- **If you have an active salary negotiation coming up:** → Projects ("Salary Negotiation 2024")
- **If negotiation is an ongoing skill you're developing:** → Areas ("Professional Development") or Resources ("Negotiation")
- **If it's just interesting:** → Resources ("Communication Skills")
...
- Traditional topic-based organization fails because it separates information from action
- PARA (Projects, Areas, Resources, Archives) organizes information by actionability — where you'll need it
- Projects are active efforts with deadlines; Areas are ongoing responsibilities; Resources are interests; Archives are inactive items
- Information flows through PARA as your life changes — the system is dynamic, not static
- Apply PARA consistently across all your digital tools to create one unified system
- The organizing question is always: "Where will I need this when I need it?"
