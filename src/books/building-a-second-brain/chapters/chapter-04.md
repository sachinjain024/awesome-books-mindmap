...
> "It's not about saving everything — it's about saving the right things."
> — Tiago Forte
...
### What Deserves to Be Captured {.code-box}

Forte identifies four types of content that typically deserve capture:

- **Inspiring:** Ideas that inspire you and make you think differently
- **Useful:** Information you'll need for a specific project or goal
- **Personal:** Notes from your own thinking — journal entries, reflections, realizations
- **Surprising:** Things that challenge your assumptions or shift your worldview
...
- Does this relate to a **current project** I'm working on?
- Does this relate to an **ongoing area** of responsibility?
- Is this a piece of **inspiration** that excites me right now?
- Is this **surprising** — does it challenge what I thought I knew?

If you can answer yes to any of these, save it. If not, let it go.

### The 12 Favorite Problems {.insight-box}
...
- Capture is the first step of CODE, but it does not mean saving everything — selectivity is essential
- The resonance filter — saving what makes you feel something — is the most important capture criterion
- Capture happens across tools: reading highlights, voice memos, note apps, and your own thinking
- Ask "Would my future self find this useful?" to filter captures in the moment
- The Twelve Favorite Problems technique turns capture from random to purposeful
- Always add brief context when saving — a sentence about *why* makes notes infinitely more valuable
