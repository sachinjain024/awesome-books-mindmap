...
> "Information becomes knowledge only when you use it to create something."
> — Tiago Forte
...
## The Intermediate Packet Revolution
...
- A distilled set of research notes
- A completed outline
- A draft introduction
- A set of examples or case studies
- A collection of relevant quotes
- A reusable slide or diagram
...
### Why IPs Change Everything {.code-box}
...
## Assembling, Not Creating From Scratch
...
### Four Types of Intermediate Packets {.technique-box}

1. **Distilled Notes:** Notes you've progressively summarized — ready to be incorporated into a project
2. **Outtakes:** Content cut from a previous project that might be used in a future one
3. **Work-in-Progress:** Drafts in various stages of completion
4. **Final Deliverables:** Completed projects, preserved so they can be reused or referenced
...
- Express is the final and most important step — all previous steps exist to support creative output
- Intermediate Packets (IPs) are discrete, reusable units of work — the building blocks of creative projects
- Working in IPs makes creativity modular, resilient to interruption, and far more efficient
- Retrieval methods (search, browse, tags, serendipity) help you find relevant material at the right moment
- Originality is not the standard — the most creative work is expert curation and synthesis
- The creative process shifts from "create from scratch" to "assemble from what already exists"
