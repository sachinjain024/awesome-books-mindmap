...
> "Every time you add a layer of highlighting to a note, you are doing the work of your future self."
> — Tiago Forte
...
### The Time Investment {.technique-box}

Progressive Summarization respects your time:

- **Capturing:** 1–2 minutes (just save the relevant sections)
- **First bolding:** 5 minutes (skim and bold the best parts)
- **Highlighting:** 2 minutes (mark the essential within the essential)
- **Executive summary:** 5 minutes (optional, for critical notes only)
...
### The Curator's Perspective {.insight-box}
...
- Distill makes notes future-proof — readable and useful in seconds, not minutes
- Progressive Summarization works in layers: raw note → bold the best → highlight the gold → executive summary
- Work in layers across time, not all at once — you don't know in advance which details will matter
- Distill when you retrieve (when relevance is confirmed), not when you capture
- Adopt the curator's mindset: make the most valuable material immediately visible for your future self
- Capturing your own reactions and connections is more valuable than copying the source material
