...
> "The goal of a Second Brain is not to become smarter — it's to think better by having a system that augments your thinking."
> — Tiago Forte
...
### Capture → Organize → Distill → Express {.code-box}

- **Capture:** Save the ideas, quotes, facts, and observations that resonate with you
- **Organize:** Sort what you've captured into a structure that supports action
- **Distill:** Refine your notes to surface the most essential insights
- **Express:** Use what you've gathered to create something valuable — for yourself or others
...
### Why Resonance Works {.technique-box}
...
- **Information** is raw data — facts, statistics, events
- **Knowledge** is information that has been processed, connected, and made personally meaningful
...
### The Shift to Knowledge Creation {.para-box}
...
- Each note added makes the system slightly more valuable
- Each project completed leaves behind reusable material (Intermediate Packets) for future projects
- Each time you retrieve something useful, your confidence in the system grows
- Over months and years, a rich body of personal knowledge accumulates that becomes a genuine intellectual asset
...
- The CODE framework — Capture, Organize, Distill, Express — is the engine of the Second Brain
- The biological brain is designed for pattern-matching and creativity, not reliable storage
- Resonance is the first and most important filter: save what makes you stop and pay attention
- Information becomes knowledge only when it is processed, connected, and made personally meaningful
- The Second Brain compounds in value over time — each note, each project, each retrieval makes it more useful
