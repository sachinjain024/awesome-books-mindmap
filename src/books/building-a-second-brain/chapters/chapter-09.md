...
> "Your Second Brain is only as valuable as the habits that keep it current."
> — Tiago Forte
...
### Starting a Project {.practice-box}
...
### Completing a Project {.practice-box}
...
### The Weekly Review Process {.technique-box}
...
### The Value of Regularity {.insight-box}
...
### The Monthly Review Process {.technique-box}
...
### The 10-Minute Tidy {.practice-box}
...
- A Second Brain requires regular maintenance habits to remain trustworthy and useful
- The Project Checklist ensures projects start with context and end with preserved knowledge
- The Weekly Review (30–60 min) keeps your system current and your commitments on track
- The Monthly Review ensures your system reflects your actual current goals and priorities
- The "just-in-time" principle: maintain the parts you're using, when you're using them
- Regularity matters more than depth — a consistent light review beats an occasional thorough overhaul
