...
> "The creative process is not linear — it moves between opening and closing, between exploring and refining."
> — Tiago Forte

## The Two Modes of Creative Work
...
### Divergence: Opening Up Possibilities {.insight-box}

Divergence is the mode of exploration. In divergence, you are:
- Gathering raw material without judgment
- Exploring possibilities without commitment
- Asking questions rather than seeking answers
- Suspending evaluation to allow unexpected connections
...
### Convergence: Narrowing to Completion {.insight-box}

Convergence is the mode of execution. In convergence, you are:
- Selecting from the material you've gathered
- Making decisions and commitments
- Moving toward a specific, finalized output
- Filtering ruthlessly to find what belongs
...
**How to use it:**
1. Search your Second Brain for relevant material
2. Copy your best Intermediate Packets into a working document
3. Arrange them in a rough sequence that makes sense
4. Write transitions and connective tissue

### 2. The Hemingway Bridge {.technique-box}
...
**How to use it:**
1. Before ending a session, open a note at the top of your current project
2. Write 3–5 sentences: "I'm working on X. I've gotten to Y. The next step is Z."
3. Note any open questions or unresolved issues
4. Close everything — your next session will start with this context already loaded

### 3. Dial Down the Scope {.technique-box}
...
**How to use it:**
- Ask: "What is the minimum version of this that would still be valuable?"
- Cut the less essential sections to a future project
- Commit to completing the smaller version now
- Use the cut material as the starting point for the next iteration

## The Shipping Imperative
...
- Creative work alternates between divergence (exploring possibilities) and convergence (narrowing to completion)
- Mixing these two modes creates the most common creative blocks — keep them separate
- The Archipelago of Ideas: assemble your best material first, then write the bridges between elements
- The Hemingway Bridge: end every session with notes for your future self to eliminate cold-start friction
- Dial Down the Scope: a completed smaller project beats an abandoned larger one every time
- The goal of the Second Brain is ultimately to ship — to produce creative output that creates value for others
