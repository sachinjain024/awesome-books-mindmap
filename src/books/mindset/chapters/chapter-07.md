...
meta: "Where Do Mindsets Come From?"
part: MINDSETS IN THE WORLD
layout: chapter
book: mindset
permalink: mindset/chapters/chapter-07.html
---

> "Every word and action from parent to child sends a message. Tomorrow, let's be thoughtful about the messages we send."
> — Carol S. Dweck
...
### Every Interaction Sends a Signal {.principle-box}
...
### The Fixed Mindset Transmission {.warning-box}

Dweck identifies specific types of messages that reliably transmit fixed mindsets:

- **Ability praise:** "You're so smart," "You're such a natural," "You have a real gift for this"
- **Outcome focus:** Only acknowledging success, ignoring the process and effort that led to it
- **Rescue behavior:** Always stepping in before a child can struggle and figure things out
- **Low expectations communicated as compassion:** "Not everyone can be good at math, and that's okay"
- **Comparison to others:** "Why can't you be more like your sister?"
...
### "Gifted" Labels and Their Costs {.research-box}
...
- Begin to believe that their worth is in maintaining the label
- Avoid challenges that might reveal them as not quite as gifted as promised
- Experience failure as especially threatening—if you're gifted and you fail, what does that say about you?
- Develop anxiety around performance because every result is a test of whether the label is still deserved
...
### The Process Praise Alternative {.practice-box}
...
Instead of: "You're so smart for finishing that puzzle"
Try: "You worked really hard on that puzzle. I noticed you kept trying even when you got stuck"

Instead of: "You're a natural athlete"
Try: "You've been practicing so consistently—that's why you're getting better"

Instead of: "You got an A—you're so brilliant"
Try: "You got an A! What strategies did you use to prepare? What worked well?"
...
### The Teacher Who Changes Everything {.example-box}
...
### The Hidden Curriculum of Feedback {.insight-box}
...
### The Winning-at-All-Costs Coach {.warning-box}
...
### The Developmental Coach {.practice-box}

The best developmental coaches share certain practices:
- **They teach, not just correct:** When something goes wrong, they explain why and show the better approach, rather than simply expressing displeasure.
- **They praise effort and strategy, not just outcomes:** "I noticed you kept your head in it even when the game wasn't going your way" is more developmental than "great job winning."
- **They make challenge positive:** They frame difficult training as building strength, not as punishment or evidence of weakness.
- **They make mistakes learning opportunities:** "What did you learn from that?" transforms failure from a verdict into information.
- **They develop the whole athlete:** Including the mental and emotional aspects of competition, not just physical skills.

## The Teacher Who Dweck Never Forgot

### Mrs. Wilson's Message {.example-box}
...
### A Charge to Parents, Teachers, and Coaches {.principle-box}
...
- Mindsets are transmitted through the messages children receive from adults—not just explicit messages but implicit ones embedded in how adults respond to success, failure, and effort.
- Ability praise ("you're so smart") reliably triggers fixed mindsets; process praise ("you worked so hard") cultivates growth mindsets.
- The best teachers believe in every student's capacity to develop and communicate that belief through genuinely challenging expectations combined with genuine support.
- Coaches who focus exclusively on winning rather than development create fixed mindset athletes who fear mistakes and avoid growth.
- Adults' fixed mindset beliefs about children—expressed through easier assignments, lower expectations, or rescue behavior—become self-fulfilling prophecies.
- The growth mindset can be deliberately cultivated; adults who understand the mechanism of mindset transmission can consciously choose to send messages that empower rather than limit.
